...
EasternZobrist::EasternZobrist(const quint64* keys)
    : Zobrist(keys),
      m_castlingIndex(0),
      m_pieceIndex(0)
{
...
void EasternZobrist::initialize(int squareCount,
                int pieceTypeCount)
{
...
quint64 EasternZobrist::side() const
{
    return keys()[0];
}

quint64 EasternZobrist::piece(const Piece& piece, int square) const
{
...
quint64 EasternZobrist::castling(int side, int square) const
{
